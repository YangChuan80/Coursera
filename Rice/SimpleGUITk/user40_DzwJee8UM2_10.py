...
missile_info = ImageInfo([5,5], [10, 10], 3, lifespan = 1)
...
class Ship:
    ...
    def update(self):
        ...
        if self.thrust==True:
            ...
            self.vel[0]+=accelerate[0]
            self.vel[1]+=accelerate[1]
    ...
    def shoot(self):
        ...
        a_missile.vel=[2*shoot_vel[0]+self.vel[0], 2*shoot_vel[1]+self.vel[1]]
...
def rock_spawner():
    ...
    a_rock.vel=[random.randint(-2, 2), random.randint(-2, 2)]
