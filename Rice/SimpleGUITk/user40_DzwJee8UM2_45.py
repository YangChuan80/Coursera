...
class Ship:
    ...
    def update(self):
        ...
        if self.thrust==True:
            ...
            self.vel[0]+=0.5*accelerate[0]
            self.vel[1]+=0.5*accelerate[1]
    ...
    def shoot(self):
        ...
        missile_group.add(Sprite([self.pos[0]+40*front[0], self.pos[1]+40*front[1]], 
                        [1.1*shoot_vel[0]+self.vel[0], 1.1*shoot_vel[1]+self.vel[1]], 
                        0, 0, 
...
def draw(canvas):
    ...
    if started==True:
        ...
        canvas.draw_text('Rice Rock', [WIDTH/2-100, HEIGHT/2], 60, "White")
        soundtrack.pause()
...
missile_group=set()
missile_group.add(Sprite([2 * WIDTH / 3, 2 * HEIGHT / 3], 
                        [-1,1], 
                        0, 0, 
                        missile_image, missile_info, missile_sound))
